...
<div class="tab">
<br>
  <button class="fa fa-tachometer" onclick="window.location.href='../project/dashboard.php'" >&nbsp;&nbsp;&nbspDashboard</button>
...
<button class="accordion" >Add a Nurse</button>
...
<div class="panel" align="center">
  ...
  <section class="container1">
    <div class="register">
      <h1>Add a Nurse to Database</h1>
      <form method="post" action="nur.php"><br>
        ...
        <p>&nbsp;&nbsp;&nbsp;  <input type="tel" placeholder="Enter Phone number"pattern="[0-9]{10}" title="Enter the 10 digit phone number" name="phonenumber" required> &nbsp;&nbsp;&nbsp;&nbsp; &nbsp;<input type="text" pattern="[0-9]{2}" title="Enter the 2 digit age"placeholder="Age(XX)" name="age" required></p>
	
        <p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <input type="text" pattern="[0-9]{9}" placeholder="Enter SSN" title="Enter the 9 digit SSN" name="ssn" required>
        &nbsp;&nbsp;<select name="department" id="soflow">
         <option value="" disabled selected hidden>Department Works<option>
         <option>ENT</option>
   ...
   &nbsp;&nbsp;<select name="gender" id="soflow" required>
  ...
  <option>AB+</option>
		 ...
		 <p>&nbsp;&nbsp;&nbsp;  <input type="text" placeholder="H.NO, Street" name="homeadd" required>&nbsp;&nbsp;&nbsp;&nbsp; &nbsp; <input type="text" placeholder="City" name="city" required></p>
...
<button class="accordion">View the list of Nurse</button>
<div class="panel">
  <?php
include ("database.php");

$query = "SELECT name,email,phonenumber,ssn,department FROM nurse";
