...
<button class="accordion" >Add a Doctor</button>
...
<div class="panel" align="center">
  ...
  <section class="container1">
    <div class="register">
      <h1>Add a Doctor to Database</h1>
      <form method="post" action="doc.php"><br>
...
<button class="accordion">View the list of Doctor</button>
<div class="panel">
  <?php
include ("database.php");

$query = "SELECT name,email,phonenumber,ssn,department FROM doctor";
